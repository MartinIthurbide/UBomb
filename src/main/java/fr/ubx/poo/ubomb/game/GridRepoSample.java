...
public class GridRepoSample extends GridRepo {
    ...
    private final EntityCode[][] level1 = {
            ...
            {Empty, Empty, Empty, Empty, Stone, Box, Stone, Empty, DoorNextOpened, Stone, Empty, Empty},
            ...
            {Empty, Tree, Tree, Tree, DoorNextClosed, Empty, Empty, Empty, Princess, Stone, Empty, Empty},
