...
public class GridRepoSample2 extends GridRepo {

    private final EntityCode[][] level1 = {
            {Heart, Heart, Heart, Empty, Empty, Empty, Empty, Empty, Empty, Empty, BombRangeDec, Heart},
            ...
            {Empty, Tree, Tree, Tree, DoorNextClosed, Empty, Empty, Empty, Empty, Stone, Empty, Empty},
    ...
    public GridRepoSample2(Game game) {
        super(game);
    }
